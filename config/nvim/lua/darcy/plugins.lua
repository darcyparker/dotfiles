...
vim.cmd 'autocmd BufWritePost plugins.lua PackerCompile' --when packge.lua (this files) changes, PackerCompile
...
return require('packer').startup({
  function(use)
        ...
        use 'altercation/vim-colors-solarized' -- solarized for vim
        ...
        -- Nvim Tree
        -- Also requires a patched font: https://www.nerdfonts.com/
