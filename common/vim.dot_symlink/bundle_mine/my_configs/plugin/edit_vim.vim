...
execute "nnoremap <leader>evr :NERDTree ".$HOME."/my_dotfiles/common/vim.dot_symlink/bundle_mine/my_configs<cr><cr>"
execute "nnoremap <leader>evp :NERDTree ".$HOME."/my_dotfiles/common/vim.dot_symlink/bundle_mine/my_plugin_configs<cr><cr>"
